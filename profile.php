...
<body>
          ...
          <div class="col-12">
            <div class="top-header-content d-flex align-items-center justify-content-between">
              ...
              <div class="top-header-meta">
                <p>Welcome to <span>Kaapi Nutrition</span>, we hope you will enjoy and have good experience</p>
              </div>
              <!-- Top Header Content -->
              <div class="top-header-meta text-right">
                <a href="#" data-toggle="tooltip" data-placement="bottom" title="noreplykaapimanagement@gmail.com"><i class="fa fa-envelope-o" aria-hidden="true"></i> <span>Email: noreplykaapimanagemen@gmail.com</span></a>
  ...
  <div class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url('img/bg-img/aboutus.jpg');">
