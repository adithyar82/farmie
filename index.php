      ...
      <div class="contact-form-area">
        <form method="POST" action="details.php">
          <div class="row" style = "margin-left: 10%" >
            ...
            <div class="col-lg-3">
              <input type="text" style = "background-color: #77b122; color: white; font-size: 20px;" class="form-control" name="name" value = "Seasons" disabled>
            </div>
            <div class="col-lg-3">
            ...
            <div class="col-lg-3">
              <input type="text" style = "background-color: #77b122; color: white; font-size: 20px;" class="form-control" name="name" value = "Rainfall" disabled>
            </div>
            <div class="col-lg-3">
              <label class="checkbox-inline">
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="section-heading text-center">
            ...
            <h2><span>Integrated Plantation Management</span> For Coffee</h2>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
          ...
          <div class="section-heading text-center">
            <p>Make the green world</p>
            <h2><span>Diversification for</span> Multiple Cropping </h2>
            <img src="img/core-img/decor2.png" alt="">
          </div>
        </div>
      </div>
