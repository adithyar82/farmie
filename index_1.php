        ...
        <form method="POST" action="fertilizers.php">
          <div class="row" style = "margin-left: 10%" >
            ...
            <?php
              ...
              <div class="col-lg-2">
                <h3> N : '.round($nitrogen_final_value) .'&nbsp; kg/acre &nbsp;</h3>
              </div>
              <div class="col-lg-2">
              ...
              <div class="col-lg-2">
                <h3> P :  '.round($phosphorus_final_value).' &nbsp; kg/acre &nbsp;</h3>
              </div>
              <div class="col-lg-2">
              ...
              <div class="col-lg-2">
                <h3> K : '.round($potassium_final_value).' &nbsp; kg/acre &nbsp;</h3>
              </div>
              <div class="col-lg-2">
            ...
            if($season_count == 2){
              ...
              <div class="col-lg-2">
                <h3> Bag '.round($nitrogen_final_value/50) .'</h3>
              </div>
              <div class="col-lg-2">
              <h3> N : '.round($nitrogen_final_value) .'&nbsp; kg/acre &nbsp;</h3>
              </div>
              ...
              <div class="col-lg-2">
                <h3> Bag '.round($phosphorus_final_value/50) .' </h3>
              </div>
              <div class="col-lg-2">
               <h3> P: '.round($phosphorus_final_value) .'&nbsp; kg/acre &nbsp;</h3>
              </div>
              ...
              <div class="col-lg-2">
                <h3> N : '.round($phosphorus_final_value) .'&nbsp; kg/acre &nbsp;</h3>
              </div>
              <div class="col-lg-2">
                <h3> Bag '.($phosphorus_final_value/50) .' </h3>
              </div>
