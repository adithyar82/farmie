      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-lg-12">
          <div class="about-us-content mb-100">
            ...
            berry borer<br>
            Begin the harvesting and processing of robusta<br>
            Control measures against mealy bugs, if found<br>
            Fire path clearing around the estate<br>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-12 col-lg-12">
          <div class="about-us-content mb-100">
            ...
            <p style = "font-size:18px;">Continue harvesting and processing of robusta coffee<br>
            Complete the collection of left over and fallen berries to avoid coffee berry borer<br>
            Install Broca traps for Berry Borer management<br>
            Pre Blossom fertilizer application in robusta<br>
            Blossom irrigation in robusta during second fortnight<br>
            Control mealy bugs, if found<br>
            Complete fire path clearing around estate<br>
            Take up Arabica pruning, if sufficient rains are received<br>
